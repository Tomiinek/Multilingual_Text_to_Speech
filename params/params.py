...
class Params:
    ...
    encoder_type = "simple" # one of: simple (single encoder for all languages without embedding), 
                            ...
                            #         generated (same as convolutional but with parameters generated by a meta network)
    encoder_dimension = 512
    encoder_blocks = 3
    encoder_kernel_size = 5
    generator_dim = 8               # used if encoder_type is 'generated'
    generator_bottleneck_dim = 4    # used if encoder_type is 'generated'
